...
export interface CardProductVariant02Props extends HTMLAttributes<HTMLElement> {
...
export function CardProductVariant02({
  style,
  textblockDetailsProps,
...
const seldon: CardProductVariant02Props = {
  textblockDetailsProps: {
    style: {
